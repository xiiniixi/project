...
public final class ContextColorSchemeProvider$provideColorMap$1 extends Lambda implements Function3<Integer, Integer, TypedArray, Unit> {
    final /* synthetic */ Map $result;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContextColorSchemeProvider$provideColorMap$1(Map map) {
        super(3);
        this.$result = map;
    }
